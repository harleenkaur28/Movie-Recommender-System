...
movies_dict = pickle.load(open('/Users/harleen/Desktop/Codes/Python/Movie Recommender System/movies.pkl','rb'))
movies = pd.DataFrame(movies_dict)
movies_list = movies['title'].values
similarity = pickle.load(open('/Users/harleen/Desktop/Codes/Python/Movie Recommender System/similarity.pkl' , 'rb'))
